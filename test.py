...
def NN(epoch, net, memory, trainloader, testloader, recompute_memory=0):
    net.eval()
...
def kNN(epoch, net, memory, trainloader, testloader, K, sigma, recompute_memory=0):
    net.eval()
    net_time = AverageMeter()
    cls_time = AverageMeter()
    total = 0
